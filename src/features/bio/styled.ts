...
interface selectCharacterButton {
     active: boolean
}

export const Button = styled.button<selectCharacterButton>
`
border-radius: 5px;
...
background-color: ${({active}) => active? "#fdd835": null};
color: ${({active})=>active? "whitesmoke":null };
